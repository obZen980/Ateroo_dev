...
export class AterooKanbanDashboardRenderer extends KanbanRenderer {
    setup() {
        super.setup();
    }
...
export const AterooKanbanDashboard = {
    ...kanbanView,
    Renderer: AterooKanbanDashboardRenderer,
};

registry.category("views").add("ateroo_dashboard_kanban", AterooKanbanDashboard);
